...
___CSS_LOADER_EXPORT___.push([module.id, `:root {
  ...
  line-height: 1.2rem;
  --primary-color: #638889;
  --secondary-color: #9dbc98;
  --accent-color: #ebd9b4;
  --neutral-color: #f9efdb;
...
.modal {
  ...
  color: white;
  border: thin solid var(--neutral-color);
...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAEA;EACE,wDAAwD;EACxD,mBAAmB;EACnB,wBAAwB;EACxB,0BAA0B;EAC1B,uBAAuB;EACvB,wBAAwB;;EAExB,sCAAsC;EACtC,qCAAqC;EACrC,mCAAmC;AACrC;;AAEA,WAAW;AACX;EACE,SAAS;EACT,UAAU;EACV,sBAAsB;AACxB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,WAAW;EACX,gBAAgB;EAChB,yBAAyB;AAC3B;;AAEA;;EAEE,kBAAkB;AACpB;;AAEA;EACE,qCAAqC;AACvC;;AAEA;EACE,QAAQ;EACR,SAAS;EACT,oBAAoB;;EAEpB,yBAAyB;EACzB,sCAAsC;EACtC,YAAY;EACZ,uCAAuC;EACvC,qBAAqB;EACrB,uCAAuC;EACvC,aAAa;AACf;;AAEA;EACE,cAAc;EACd,WAAW;AACb;;AAEA,SAAS;;AAET;EACE,wCAAwC;EACxC,eAAe;EACf,qCAAqC;AACvC;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,iBAAiB;EACjB,cAAc;AAChB;;AAEA;EACE,OAAO;AACT;;AAEA;EACE,aAAa;EACb,WAAW;EACX,yBAAyB;AAC3B;;AAEA;EACE,aAAa;EACb,WAAW;EACX,oBAAoB;EACpB,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,eAAe;EACf,sCAAsC;EACtC,qBAAqB;EACrB,6BAA6B;EAC7B,yBAAyB;AAC3B;AACA;EACE,sCAAsC;EACtC,wBAAwB;EACxB,sCAAsC;AACxC;;AAEA;EACE,WAAW;EACX,cAAc;EACd,aAAa;EACb,eAAe;EACf,qCAAqC;EACrC,qBAAqB;EACrB,yCAAyC;AAC3C;;AAEA;EACE,yBAAyB;EACzB,mBAAmB;AACrB;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,gBAAgB;EAChB,mBAAmB;EACnB,gBAAgB;EAChB,uBAAuB;AACzB;;AAEA,eAAe;AACf;EACE,qBAAqB;EACrB,6BAA6B;AAC/B;AACA;EACE,wBAAwB;EACxB,sCAAsC;AACxC;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,2BAA2B;EAC3B,WAAW;AACb;;AAEA,kBAAkB;;AAElB;EACE;IACE,UAAU;IACV,gBAAgB;EAClB;AACF","sourcesContent":["@import url(\"https://fonts.googleapis.com/css2?family=Nunito+Sans:opsz,wght@6..12,200;6..12,400&display=swap\");\n\n:root {\n  font-family: \"Nunito Sans\", Arial, Helvetica, sans-serif;\n  line-height: 1.2rem;\n  --primary-color: #638889;\n  --secondary-color: #9dbc98;\n  --accent-color: #ebd9b4;\n  --neutral-color: #f9efdb;\n\n  background-color: var(--neutral-color);\n  --text-md: clamp(1rem, 1.5vw, 1.5rem);\n  --text-sm: clamp(0.7rem, 2vw, 2rem);\n}\n\n/* Global */\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\nselect {\n  font-size: 1em;\n}\n\ntable {\n  width: 100%;\n  margin-top: 1rem;\n  font-size: var(--text-md);\n}\n\ntd,\ntr {\n  text-align: center;\n}\n\nthead td {\n  background-color: var(--accent-color);\n}\n\n.modal {\n  top: 50%;\n  left: 50%;\n  translate: -50% -50%;\n\n  font-size: var(--text-md);\n  background-color: var(--primary-color);\n  color: white;\n  border: thin solid var(--neutral-color);\n  border-radius: 0.2rem;\n  box-shadow: 10px 10px rgb(0, 0, 0, 0.2);\n  padding: 1rem;\n}\n\n.modal input {\n  display: block;\n  width: 100%;\n}\n\n/* Main */\n\n.header-container {\n  background-color: var(--secondary-color);\n  padding: 0.4rem;\n  box-shadow: 0px 1px rgb(0, 0, 0, 0.2);\n}\n\n.header {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  max-width: 1400px;\n  margin: 0 auto;\n}\n\n.header > * {\n  flex: 1;\n}\n\n.logo {\n  display: flex;\n  gap: 0.5rem;\n  font-size: var(--text-md);\n}\n\n.nav {\n  display: flex;\n  gap: 0.2rem;\n  justify-content: end;\n  flex-basis: 2px;\n}\n\n.nav-card {\n  display: flex;\n  align-items: center;\n  padding: 0.1rem;\n  background-color: var(--neutral-color);\n  border-radius: 0.5rem;\n  border: 4px solid transparent;\n  font-size: var(--text-md);\n}\n.nav-card:hover {\n  background-color: var(--primary-color);\n  transition: border 500ms;\n  border: 4px solid var(--neutral-color);\n}\n\n.content-container {\n  width: 100%;\n  margin: 0 auto;\n  padding: 1rem;\n  margin-top: 1px;\n  background-color: var(--accent-color);\n  border-radius: 0.5rem;\n  box-shadow: 0 2px 2px 0 rgb(0, 0, 0, 0.1);\n}\n\n.projects-dropdown {\n  font-size: var(--text-md);\n  margin-bottom: 1rem;\n}\n\n.tasks-action {\n  font-size: var(--text-md);\n}\n\n.task-title {\n  max-width: 100px;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n\n/* Components */\n.act-btn {\n  border-radius: 0.5rem;\n  border: 2px solid transparent;\n}\n.act-btn:hover {\n  transition: border 250ms;\n  border: 2px solid var(--neutral-color);\n}\n\n.add-btn {\n  color: green;\n}\n\n.del-btn {\n  color: red;\n}\n\n.edit-btn {\n  color: blue;\n}\n\n.info-btn {\n  color: aqua;\n}\n\n.completed {\n  background-color: lightgray;\n  color: gray;\n}\n\n/* Media Queries */\n\n@media screen and (min-width: 1000px) {\n  .content-container {\n    width: 70%;\n    max-width: 60rem;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
function Storage() {
  ...
  function addProject(name, desc) {
    const project = new _Project__WEBPACK_IMPORTED_MODULE_0__["default"](name, desc);
  ...
  function addTask(title, description, dueDate, priority) {
    const task = new _Task__WEBPACK_IMPORTED_MODULE_1__["default"](title, description, dueDate, priority);
  ...
  function getWeekTasks() {
    const weekTasks = getAllTasks().filter((element) => {
      return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.isThisWeek)(element);
    });
  ...
  function getTodayTasks() {
    const todayTasks = getAllTasks().filter((element) => {
      return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.isToday)(element);
    });
...
const storage = (0,_Storage__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
function UI() {
  ...
  function loadProject() {
    ...
    project.tasks.forEach((task) => {
      ...
      <td class="task-dueDate">${(0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(task.dueDate, "dd/MM/yyyy")}</td>
